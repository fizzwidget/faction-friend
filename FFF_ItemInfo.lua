...
-- Warlords of Draenor factions
	...
	STEAMWHEEDLE_EXPEDITION = 1732,
	ARAKKOA_OUTCASTS = 1515,
	BARRACKS_BODYGUARDS = 1735,
	AWAKENED_ORDER = 1849,
	SHADOWMOON_EXILES = 1520,
	SABERSTALKERS = 1850,
-- Horde
...
-- Barrack Bodyguards
	LEORAJH = 1741,
	TORMMOK = 1736,
	TALONPRIEST_ISHAAL = 1737,
	-- Alliance
	DEFENDER_ILLONA = 1738,
	DELVAR_IRONFIST = 1733,
	-- Horde
	VIVIANNE = 1739,
	AEDA_BRIGHTDAWN = 1740,

-- Legion
	NIGHTFALLEN_OCULETH = 1862,
	NIGHTFALLEN_THALYSSRA = 1860,
	NIGHTFALLEN_VALTROIS = 1919,
	FARONDIS_COURT = 1900,
	DREAMWEAVERS = 1883,
	GILNEAN_SURVIVORS = 1815,
	HIGHMOUNTAIN_TRIBE = 1828,
	MOON_GUARD = 1989,
	MOONGUARD = 1899, -- ??
	ILLIDARI = 1947,
	JANDVIK_VRYKUL = 1888,
	FIRST_RESPONDERS = 1984,
	THE_WARDENS = 1894,
	VALARJAR = 1948,
}
